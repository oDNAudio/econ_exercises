...
Here we try reproduce Table 11.1 (Koop 2015) with our function.

```{r include=FALSE}
table = ssvs(y, X, save = 20000, burn = 5000)
table_df = data.frame(names(table$pip), round(table$pip, 3), round(table$post_mean, 3), round(table$post_var_beta, 3), row.names = NULL)
names(table_df) = c("Expl. Var.", "SSVS PIP", "Post. Mean", "Post. Beta-Var.")
```
